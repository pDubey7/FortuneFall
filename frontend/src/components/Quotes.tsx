...
export const Quotes = () => {
  ...
  return (
    <div className="flex mx-16 flex-col justify-center pb-10 ">
      <h1 className="text-6xl font-bold">Play FutureFall, Earn More!</h1>
      <h3 className="mt-4 text-xl mb-4">
        FutureFall lets players drop a ball from the top of our triangular pin
        pyramid to find the winning route down to a corresponding multiplier.
        Inspired by the Japanese mechanical game known as Pachinko, FutureFall
